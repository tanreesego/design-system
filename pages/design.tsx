    ...
    >
      ...
      <Section size="3">
        <Container size="2">
          ...
          <Paragraph>
            ...
            <Code>console.log(&apos;Radix&apos;).console</Code> is for positive states. Traditional
            business literature won’t help you solve it- most of that stuff is focused on life after
            product/market fit, after the Trough of Sorrow. A lot of startup stuff is focused on the
      ...
      <Section size="3">
        <Container size="2">
          ...
          <Paragraph>
            ...
            on life after product/market fit, after the Trough of Sorrow. A lot of startup stuff is
      ...
      <Section size="3">
        <Container size="2">
          ...
          <Flex align="start" wrap="wrap" css={{ gap: '$2', mt: '$6' }}>
            <Alert variant="loContrast" css={{ width: '200px' }}>
              <Text size="3" css={{ fontWeight: 500, lineHeight: '20px', mb: '$1' }}>
                Alert heading
              </Text>
              <Text size="2" variant="gray" css={{ lineHeight: '17px' }}>
                A modal dialog that interrupts the user with <Link href="#">important content</Link>{' '}
                and expects a response.
              </Text>
            </Alert>
            <Alert variant="gray" css={{ width: '200px' }}>
              <Text size="3" css={{ fontWeight: 500, lineHeight: '20px', mb: '$1' }}>
                Alert heading
              </Text>
              <Text size="2" variant="gray" css={{ lineHeight: '17px' }}>
            ...
            <Alert variant="blue" css={{ width: '200px' }}>
            ...
            <Alert variant="green" css={{ width: '200px' }}>
              <Text
                size="3"
                variant="green"
            ...
            <Alert variant="red" css={{ width: '200px' }}>
